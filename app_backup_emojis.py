            ...
            if original_row is not None and row['importancia'] != original_row['importancia']:
                ...
                if conn:
                    try:
                        ...
                        st.success(f"[OK] Importancia actualizada a '{row['importancia']}'")
                        time.sleep(0.5)
    ...
    try:
        ...
        with alert_grid.container():
            if data['reportes_vencidos'] > 0:
                ...
                st.success("[OK] **Cumplimiento Legal**: Todos los reportes están dentro del plazo")
                st.markdown("""
                ...
                if data['detalles_proximos_vencer']:
                    ...
                    for detalle in data['detalles_proximos_vencer']:
                        ...
                        if status == 'vencido':
                            ...
                            badge_html = f'<span style="background: #28a745; color: white; padding: 4px 8px; border-radius: 12px; font-size: 0.75em; font-weight: 600;">[OK] {dias_restantes} días restantes</span>'
        ...
        if data['reportes_vencidos'] == 0 and data['proximos_vencer'] == 0:
            if data['total_boletines'] > 0:
                st.success("[OK] ¡Excelente! Todos los reportes están dentro del plazo legal y bajo control")
...
if tabs == 'Dashboard':
    ...
    if conn:
        try:
            ...
            if reportes_pendientes > 0:
                ...
                if st.button("🚀 Generar Todos los Informes", type="primary", use_container_width=True):
                    ...
                    if resultado['success']:
                        if resultado['message'] == 'no_pending':
                            st.success("[OK] No hay informes pendientes de generación")
                        elif resultado['message'] == 'completed':
                            if resultado['reportes_generados'] > 0:
                                st.success(f"[OK] Se generaron {resultado['reportes_generados']} informes correctamente")
                ...
                st.success("[OK] Todos los informes están actualizados")
        except Exception as e:
            st.error(f"Error: {e}")
        finally:
            conn.close()
    ...
    # Sección temporalmente eliminada para testing
    st.info("⚠️ Sección de estadísticas temporalmente deshabilitada para testing")
    st.markdown("---")
    st.markdown("### Sistema de Gestión de Boletines")
...
<div style="background: #f8f9fa; padding: 1.5rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); margin: 1rem 0; border-left: 4px solid #667eea;">
    ...
    <div style="margin: 1rem 0; color: #000000;">
        ...
        <ol style="margin: 0; padding-left: 1.5rem; line-height: 1.8; color: #000000;">
            <li><strong style="color: #000000;">Seleccionar archivo:</strong> Elija un archivo XLSX con los datos del boletin</li>
            <li><strong style="color: #000000;">Vista previa:</strong> Revise los datos extraidos antes de importar</li>
        ...
        <div style="background: #e7f3ff; padding: 1rem; border-radius: 8px; margin-top: 1rem; border-left: 4px solid #667eea; color: #000000;">
            <strong style="color: #000000;">Tip:</strong> Asegurese de que el archivo tenga el formato correcto antes de cargar.
        </div>
    </div>
</div>
""", unsafe_allow_html=True)
...
<div style="border: 2px dashed #667eea; border-radius: 16px; padding: 2rem; text-align: center; background: rgba(102, 126, 234, 0.05); margin: 1rem 0;">
    <div style="font-size: 3rem; color: #667eea; margin-bottom: 1rem;">[ICONO]</div>
    ...
    if archivo:
        ...
        <div style="background: #f8f9fa; padding: 1.5rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); margin: 1rem 0; border-left: 4px solid #28a745;">
            <div style="display: flex; align-items: center; margin-bottom: 1rem;">
                ...
                <h3 style="color: #000000 !important; margin: 0;">[OK] Archivo Cargado Exitosamente</h3>
            </div>
            <div style="margin: 1rem 0; color: #000000;">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div style="color: #000000;">
                        <strong style="color: #000000;">📄 Nombre:</strong> {archivo.name}<br>
                        <strong style="color: #000000;">📊 Tamaño:</strong> {archivo.size / 1024:.1f} KB
                    </div>
                    <div style="color: #000000;">
                        <strong style="color: #000000;">📅 Tipo:</strong> {archivo.type}<br>
                        <strong style="color: #000000;">⏰ Estado:</strong> <span style="background: #28a745; color: white; padding: 4px 8px; border-radius: 12px; font-size: 0.75em; font-weight: 600;">[OK] Listo para procesar</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        try:
            ...
            if datos_agrupados:
                    ...
                    if conn:
                        try:
                            ...
                            if import_button:
                                ...
                                st.success("[OK] ¡Datos importados exitosamente!")
                                ...
                                <div style="background: #f8f9fa; padding: 1.5rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); margin: 1rem 0; border-left: 4px solid #28a745;">
                                    ...
                                    <div style="text-align: center; margin: 1rem 0; color: #000000;">
                                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                                            <div style="color: #000000;">
                                                <div style="font-size: 2rem; color: #28a745; margin-bottom: 0.5rem;">[OK]</div>
                ...
                colored_header(
                    label="[ICONO] Vista Previa de Datos",
                ...
                for titular, registros in datos_agrupados.items():
                    with st.expander(f"📁 {titular} ({len(registros)} registros)", expanded=False):
                        ...
                        <div style="background: #f8f9fa; padding: 1rem; border-radius: 8px; margin-bottom: 1rem;">
                            ...
                            <span style="background: #28a745; color: white; padding: 4px 8px; border-radius: 12px; font-size: 0.75em; font-weight: 600;">[OK] Válido</span>
                        </div>
                        """, unsafe_allow_html=True)
                                ...
                                if not original_row.empty:
                                    ...
                                    if cambios:
                                        ...
                                        try:
                                            ...
                                            st.success(f"[OK] Cliente '{row['titular']}' actualizado: {', '.join(campos_cambiados)}")
                                            time.sleep(0.5)
                                    ...
                                    if st.button("🗑️ Eliminar Cliente", type="secondary", use_container_width=True):
                                        ...
                                        if st.button("⚠️ Confirmar Eliminación", type="primary"):
                                            try:
                                                ...
                                                st.success(f"[OK] Cliente '{selected_client['titular']}' eliminado")
                                                time.sleep(1)
                                                st.rerun()
                                            except Exception as e:
                                ...
                                if validate_email_format(nuevo_email):
                                    try:
                                        ...
                                        if existe:
                                            ...
                                            st.success("[OK] Cliente agregado correctamente")
        ...
        try:
            ...
            if stats:
                    ...
                    if stats['pendientes_revision'] == 0 and stats['listos_envio'] > 0:
                                    ...
                                    try:
                                        ...
                                        if preview_data:
                                            ...
                                            preview_df['Estado'] = preview_df['Email'].apply(
                                                lambda x: "[OK] Listo" if x and x.strip() else "❌ Sin Email"
                                            )
                            ...
                            with col2:
                                ...
                                if credenciales['email']:
                                    st.success(f"[OK] Email configurado: {credenciales['email']}")
                                ...
                                if credenciales['email'] and credenciales['password']:
                                    ...
                                    if st.session_state.get('confirmar_envio_emails', False):
                                        ...
                                        with col_conf1:
                                            if st.button("[OK] Sí, Enviar", type="primary", use_container_width=True):
                                                ...
                                                with st.spinner(f"Enviando {stats['listos_envio']} emails..."):
                                                    try:
                                                        ...
                                                        if "Pendiente" in str(e):
                                                            st.info("[ICONO] Ve a la sección 'Historial' para cambiar la importancia de los reportes pendientes.")
                                        with col_conf2:
                                        ...
                                        if 'resultados_envio' in st.session_state and st.session_state.resultados_envio:
                                            ...
                                            with col_r1:
                                                st.metric("[OK] Exitosos", len(resultados['exitosos']))
                                            with col_r2:
                                                st.metric("❌ Fallidos", len(resultados['fallidos']))
                                            with col_r3:
                                                st.metric("📧 Sin Email", len(resultados['sin_email']))
                                            with col_r4:
                                                st.metric("[ICONO] Sin Archivo", len(resultados['sin_archivo']))
                                            ...
                                            if len(resultados['exitosos']) > 0:
                                                ...
                                                with st.expander(f"📧 Ver detalles de envíos exitosos ({len(resultados['exitosos'])})", expanded=False):
                                                    for envio in resultados['exitosos']:
                                                        ...
                                                        st.write(f"[OK] **{titular}** ({importancia}) → {email} ({cantidad} boletines)")
                                        ...
                                        if validacion['listos_para_envio'] > 0:
                                            st.success(f"[OK] {validacion['listos_para_envio']} grupos listos para recibir emails")
                        ...
                        st.success("[OK] No hay reportes pendientes de envío")
                ...
                with tab2:
                            ...
                            with col2:
                                st.markdown("##### [ICONO] Gestión de Credenciales")
                                                        ...
                                                        try:
                                                            ...
                                                            if validar_credenciales_email(nuevo_email, nueva_password):
                                                                ...
                                                                if save_email_credentials(nuevo_email, nueva_password):
                                                                    ...
                                                                    st.success("[OK] Credenciales guardadas exitosamente")
                                                                    time.sleep(1)
                                                                    st.rerun()
                                                                else:
                                                ...
                                                if validate_email_format(nuevo_email):
                                                    with st.spinner("Validando..."):
                                                        try:
                                                            from email_sender import validar_credenciales_email
                                                            if validar_credenciales_email(nuevo_email, nueva_password):
                                                                st.success("[OK] Credenciales válidas")
                                                            else:
                                ...
                                st.markdown("##### [ICONO]📝 Plantillas de Mensaje")
                                ...
                                if stats['pendientes_revision'] == 0:
                                    st.success("[OK] Sistema listo para envíos")
                                else:
                ...
                with tab4:
                            ...
                            try:
                                ...
                                with col2:
                                    st.metric("[OK] Exitosos", stats_logs['exitosos'])
                                with col3:
                                    ...
                                    with col_admin1:
                                        if st.button("🗑️ Limpiar Logs Antiguos (30+ días)", use_container_width=True):
                                            try:
                                                ...
                                                if eliminados > 0:
                                                    st.success(f"[OK] {eliminados} logs antiguos eliminados")
                                                else:
