...
if tabs == 'Dashboard':
    ...
    if conn_stats:
        try:
            ...
            <div style='background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); 
                        padding: 20px; border-radius: 15px; margin: 15px 0; color: white; text-align: center;'>
                <div style='font-size: 2.2em; font-weight: 700; margin-bottom: 5px;'>{data['total_boletines']}</div>
                <div style='font-size: 1em; opacity: 0.9;'>Total Boletines</div>
                <div style='font-size: 0.9em; opacity: 0.8; margin-top: 8px;'>
                    {data['total_boletines'] - data['reportes_generados']} pendientes
                </div>
            </div>
            """, unsafe_allow_html=True)
            ...
            with col1:
                ...
                st.markdown(f"""
                <div style='background: #f1f5f9; padding: 15px; border-radius: 10px; text-align: center; border-left: 4px solid #10b981;'>
                    <div style='font-size: 1.5em; font-weight: 600; color: #10b981;'>{data['reportes_generados']}</div>
                    <div style='font-size: 0.8em; color: #64748b;'>Generados</div>
                    <div style='font-size: 0.7em; color: #10b981;'>{percentage_gen:.0f}%</div>
                </div>
                """, unsafe_allow_html=True)
            ...
            with col2:
                ...
                st.markdown(f"""
                <div style='background: #f1f5f9; padding: 15px; border-radius: 10px; text-align: center; border-left: 4px solid #3b82f6;'>
                    <div style='font-size: 1.5em; font-weight: 600; color: #3b82f6;'>{data['reportes_enviados']}</div>
                    <div style='font-size: 0.8em; color: #64748b;'>Enviados</div>
                    <div style='font-size: 0.7em; color: #3b82f6;'>{percentage_env:.0f}%</div>
                </div>
                """, unsafe_allow_html=True)
                
        except Exception as e:
            st.markdown("""
            <div style='background: #fef2f2; padding: 15px; border-radius: 10px; text-align: center; border-left: 4px solid #ef4444;'>
                <div style='color: #ef4444; font-size: 0.9em;'>📊 Cargando estadísticas...</div>
            </div>
            """, unsafe_allow_html=True)
        finally:
            conn_stats.close()
    ...
    <div style='text-align: center; padding: 20px 0;'>
        <div style='color: #64748b; font-size: 0.8em; margin-bottom: 10px;'>
            <strong>v2.1.0</strong> • 2024
        </div>
        <div style='display: flex; justify-content: center; gap: 15px;'>
            <a href='mailto:martingiacosa@gmail.com' style='color: #3b82f6; text-decoration: none; font-size: 0.9em;'>
                📧 Soporte
            </a>
            <span style='color: #e2e8f0;'>|</span>
            <a href='#' style='color: #3b82f6; text-decoration: none; font-size: 0.9em;'>
                📖 Docs
            </a>
        </div>
    </div>
